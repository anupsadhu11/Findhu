                ...
                <div className=\"space-y-4\">
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => setSearchData({...searchData, property_type: value})}>
                      ...
                      <SelectContent>
                        <SelectItem value=\"agricultural_land\">Agricultural Land / खेती की ज़मीन</SelectItem>
                        <SelectItem value=\"residential_plot\">Residential Plot / रिहायशी प्लॉट</SelectItem>
                        <SelectItem value=\"house\">House / घर</SelectItem>
                  ...
                  <div>
                    ...
                    <Select onValueChange={(value) => setSearchData({...searchData, search_type: value})}>
                      ...
                      <SelectContent>
                        <SelectItem value=\"legal_verification\">Legal Verification / कानूनी सत्यापन</SelectItem>
                        <SelectItem value=\"ownership\">Ownership Check / स्वामित्व जांच</SelectItem>
                        <SelectItem value=\"encumbrance\">Encumbrance Certificate / भार प्रमाण पत्र</SelectItem>
                        <SelectItem value=\"7_12_extract\">7/12 Extract / सातबारा</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div>
